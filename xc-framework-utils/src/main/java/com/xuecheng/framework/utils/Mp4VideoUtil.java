...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "C:\\soft\\ffmpeg\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\data\\video\\test1.avi";
     ...
     * @param mp4_name       新生成的mp4文件名称
     * @param mp4folder_path 新生成的文件路径
     */
